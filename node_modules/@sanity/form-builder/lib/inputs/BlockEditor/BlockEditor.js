...
function findEditNode(focusPath, editorValue, editor) {
  var focusBlockKey = focusPath[0] && focusPath[0]._key;
  ...
  var focusInlineKey = !isVoidRootBlock && focusPath[1] && focusPath[1] === 'children' && focusPath[2] && focusPath[2]._key;
  var markDefKey = !isVoidRootBlock && focusPath[2] && focusPath[1] === 'markDefs' && focusPath[2]._key;
  var key;
