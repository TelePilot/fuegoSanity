...
function createPatchesToChange(blockContentFeatures, blockContentType) {
  ...
  function patchSpanText(patch, editor, node, blockNode) {
    ...
    throw new Error("Don't know how to handle ".concat(patch.type, " here"));
  } // eslint-disable-next-line complexity
  ...
  return function patchToOperations(patch, editorValue) {
    ...
    var isVoidRootBlock = firstKey && editorValue && editorValue.document && editorValue.document.size > 0 && controller.query('isVoid', editorValue.document.getDescendant(firstKey));
