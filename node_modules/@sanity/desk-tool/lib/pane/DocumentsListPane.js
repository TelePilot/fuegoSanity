...
var _default = (0, _router.withRouterHOC)((_temp = _class = class DocumentsListPane extends _react.default.PureComponent {
  constructor(props) {
    ...
    _defineProperty(this, "getLinkStateForItem", id => {
      ...
      var panes = (router.state.panes || []).slice(0, index).concat((0, _draftUtils.getPublishedId)(id));
      return {
        panes
      };
    });
    ...
    _defineProperty(this, "handleAction", item => {
      var handler = typeof item.action === 'function' ? item.action : this.actionHandlers[item.action] || noActionFn;
    ...
    var _typeName = getTypeNameFromSingleTypeFilter(_filter, _params);

    var settingsNamespace = _settings.default.forNamespace(_typeName);
